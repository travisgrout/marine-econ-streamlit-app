...
<style>
    ...
    /* --- Custom Tab Styling --- */
    /* This selector targets the div that contains the tab's text label */
    [data-testid="stTabs"] button div {
        font-size: 1.25rem !important; /* Increase font size */
        font-weight: 600 !important;   /* Make font bolder */
    }

    /* This selector targets only the active tab button */
    [data-testid="stTabs"] button[aria-selected="true"] {
        /* Change the underline color to NOAA Sky Blue */
        border-bottom-color: #003087 !important;
    }

    /* This selector targets the text div inside the active tab button */
    [data-testid="stTabs"] button[aria-selected="true"] div {
        color: #003087 !important; /* Change the text color to NOAA Sky Blue */
    }
</style>
...
# --- State Estimates Tab ---
with tab_states:
    # FILTERS ARE NOW IN AN EXPANDER IN THE MAIN CONTENT AREA
